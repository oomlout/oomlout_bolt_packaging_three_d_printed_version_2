...
difference() {
	union() {
		...
		translate(v = [-8.0000000000, -50.5000000000, -2.5000000000]) {
			cube(size = [45, 7, 17]);
		}
	}
	union() {
		...
		translate(v = [-3.0000000000, -62.7500000000, 0.0000000000]) {
			cube(size = [6, 17.5000000000, 20]);
		}
		translate(v = [8.0000000000, -62.7500000000, 0.0000000000]) {
			cube(size = [6, 17.5000000000, 20]);
		}
