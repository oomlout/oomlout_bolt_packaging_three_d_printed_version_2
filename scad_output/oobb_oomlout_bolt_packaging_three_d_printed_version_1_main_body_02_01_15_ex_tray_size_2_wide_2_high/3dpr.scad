...
difference() {
	union() {
		...
		translate(v = [-5.0000000000, -35.0000000000, 0.0000000000]) {
			cube(size = [20, 5, 12]);
		}
	}
	union() {
		...
		translate(v = [15.0000000000, -37.5000000000, 7.5000000000]) {
			rotate(a = [0, 90, 0]) {
				difference() {
					union() {
						translate(v = [0, 0, -20.0000000000]) {
		...
		translate(v = [-2.5000000000, -47.7500000000, 0.0000000000]) {
			cube(size = [5, 17.5000000000, 15]);
		}
		translate(v = [9.0000000000, -47.7500000000, 0.0000000000]) {
