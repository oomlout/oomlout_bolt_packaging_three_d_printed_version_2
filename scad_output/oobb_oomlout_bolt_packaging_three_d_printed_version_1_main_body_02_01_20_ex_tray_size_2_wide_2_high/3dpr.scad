...
difference() {
	union() {
		...
		translate(v = [10.2500000000, 7.5000000000, 12.5000000000]) {
			rotate(a = [0, 90, 0]) {
		...
		translate(v = [-30.2500000000, 7.5000000000, 12.5000000000]) {
			rotate(a = [0, 90, 0]) {
				cylinder(h = 20, r = 6.0000000000);
			}
		}
		...
		translate(v = [12.5000000000, -37.5000000000, 0.0000000000]) {
			hull() {
		...
		translate(v = [-8.0000000000, -35.0000000000, -2.5000000000]) {
			cube(size = [41, 5, 17]);
		}
	}
	union() {
