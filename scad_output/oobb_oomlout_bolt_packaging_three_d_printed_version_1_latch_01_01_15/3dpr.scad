...
difference() {
	union() {
		...
		translate(v = [42.5000000000, -3.5000000000, 0]) {
			cube(size = [5, 7, 7.5000000000]);
		}
		translate(v = [42.5000000000, -3.5000000000, 4.5000000000]) {
			cube(size = [5, 9.2500000000, 6]);
		}
	...
	union() {
		...
		translate(v = [132.0000000000, -9.5000000000, -7.5000000000]) {
			cube(size = [6, 16, 15]);
		}
		translate(v = [143.0000000000, -9.5000000000, -7.5000000000]) {
			cube(size = [6, 16, 15]);
		}
